...
public:
	vector<string> getUrls(string url) {
		return { "http://news.yahoo.com","http://news.yahoo.com/news","http://news.yahoo.com/news/topics/","http://news.google.com","http://news.yahoo.com/us"};
	};
};
    ...
    vector<string> crawl(string startUrl, HtmlParser& htmlParser) {
		...
		while (!qu.empty()) {
			...
			for (auto child : htmlParser.getUrls(url)) {
				...
				if (hostdomain == getdomain(child) && visited.find(child) == visited.end()) {
