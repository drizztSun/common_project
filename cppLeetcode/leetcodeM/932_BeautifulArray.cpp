...
class BeautifulArray {
    ...
    void search(int n, unordered_map<int, vector<int>>& memo) {
...
void test_932_beautiful_array() {
    ...
    auto res1 = BeautifulArray().doit(4);
    
    auto res2 = BeautifulArray().doit(5);
}
