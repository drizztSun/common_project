...
func numMovesStonesII(stones []int) []int {
	...
	//
	// Lower bound:
	// Sliding window size of len(stones), find vacancy in the current window, and the number of vacancy is the number of steps
...
func Test_1040_MovingStonesUntilConsecutive() {

	numMovesStonesII([]int{6, 5, 4, 3, 10})
