...
class TicTacToe:
    ...
    """
    We use number of each line, row, and diag to figure out which player wins. if each one put a move on each row, line, diag. it should not be n. 
    ...
    def __init__(self, n: int):
        ...
        self.rows = [0] * n #rows
        self.cols = [0] * n # lines
        self.diag1 = self.diag2 = 0 # n -length diag and reverse diag
