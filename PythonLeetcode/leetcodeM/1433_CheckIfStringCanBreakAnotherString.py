...
for s2="acd" are: "acd", "adc", "cad", "cda", "dac" and "dca".
...
class CheckIfCanBreak:
    ...
    def doit_hashtable(self, s1: str, s2: str) -> bool:
        ...
        def compare(cnta, cntb):
            totala, totalb, base = 0, 0, ord('a')
            for i in reversed(range(26)):
                totala += cnta[chr(base + i)]
                totalb += cntb[chr(base + i)]
        ...
        return compare(cnt1, cnt2) or compare(cnt2, cnt1)