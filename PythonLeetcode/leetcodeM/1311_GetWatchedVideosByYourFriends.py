...
class WatchedVideosByFriends:
    ...
    def doit_(self, watchedVideos: list, friends: list, id: int, level: int) -> list:
...
if __name__ == "__main__":
    ...
    WatchedVideosByFriends().doit_(watchedVideos = [["A","B"],["C"],["B","C"],["D"]], friends = [[1,2],[0,3],[0,3],[1,2]], id = 0, level = 1)

    WatchedVideosByFriends().doit_(watchedVideos = [["A","B"],["C"],["B","C"],["D"]], friends = [[1,2],[0,3],[0,3],[1,2]], id = 0, level = 2)
