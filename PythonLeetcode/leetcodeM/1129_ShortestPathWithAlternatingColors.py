...
class ShortestAlternatingPaths:
    ...
    def doit_(self, n: int, red_edges: list, blue_edges: list) -> list:
        ...
        for c1, c2 in red_edges:
            red_graph[c1].append(c2)
        
        for c1, c2 in blue_edges:
            blue_graph[c1].append(c2)
        ...
        while queue:
            ...
            for _ in range(size):
                ...
                graph = blue_graph if color else red_graph
