...
class MinimumNumberOfVerticesToReachAllNodes:
    ...
    """
        ...
        because they can not be reached from All other nodes can be reached from any other nodes.
        Sufficient condition: All other nodes can be reached from some other nodes.

        node-no-in-degree must access with it.
        all-other node could be reachable by all other node-no-in-degree
