...
class SubdomainVisits:
    ...
    def doit(self, cpdomains):
        domain_counter = {}
        for c in cpdomains:
            amount, domain = c.split()
            amount = int(amount)
            ...
            for subdomain in reversed(domain.split('.')):
                ...
                if field not in domain_counter:
                    domain_counter[field] = 0

                domain_counter[field] += amount

        return [str(val) + ' ' + key for key, val in domain_counter.items()]
...
if __name__ == '__main__':
    ...
    # ["9001 discuss.leetcode.com", "9001 leetcode.com", "9001 com"]
    res = SubdomainVisits().doit(["9001 discuss.leetcode.com"])

    ["901 mail.com", "50 yahoo.com", "900 google.mail.com",
     "5 wiki.org", "5 org", "1 intel.mail.com", "951 com"]
    res = SubdomainVisits().doit(
        ["900 google.mail.com", "50 yahoo.com", "1 intel.mail.com", "5 wiki.org"])
