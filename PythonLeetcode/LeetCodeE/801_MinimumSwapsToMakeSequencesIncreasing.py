...
# Now, if a1 < a2 and b1 < b2, then it is allowed to have both of these columns natrual (unswapped), or both of columns swapped.
# This possbility leads to n2 = min(n2, n1) and s2 = min(s2, s1 + 1).
