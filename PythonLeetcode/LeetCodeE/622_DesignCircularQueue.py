...
class MyCircularQueue:
    ...
    def enQueue(self, value):
        ...
        self.buff[(self.head + self.num) % self.size] = value
        self.num += 1
        return True            
    ...
    def Front(self):
        ...
        :rtype: int
        """
        return self.buff[self.head] if self.num > 0 else -1
    ...
    def Rear(self):
        ...
        :rtype: int
        """
        return self.buff[(self.head + self.num - 1) % self.size] if self.num > 0 else - 1
