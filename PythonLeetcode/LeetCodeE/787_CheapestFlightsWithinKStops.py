...
class FindCheapestPrice:
    ...
    def doit_heap_dji(self, n, flights, src, dst, K):
        ...
        while pq:
            ...
            for i in range(n):
                if flightsMap[cur][i] != -1 and not visited[i]:
                    if stops + 1 <= K:
