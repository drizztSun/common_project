...
class MinimumWindowSequence:
    ...
    Time Complexity: O(ST), where S, TS,T are the lengths of S, T. We have two for-loops.
...
if __name__ == '__main__':
    ...
    MinimumWindowSequence().doit_dp(S = "abcdebdde", T = "bde")
