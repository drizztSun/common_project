...
These two facts make the work done for each state of dp have O(1)O(1) (amortized) complexity, leading to a total time complexity of O(N^2)for this solution.
"""
    def doit(self, S):
        MOD = 10 ** 9 + 7
        N = len(S)
