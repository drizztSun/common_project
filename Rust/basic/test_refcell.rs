...
impl<'a, T> LimitTrack<'a, T>
    ...
    pub fn set_value(&mut self, val: usize) {
        ...
        if percentage_of_max >= 1.0 {
            ...
            self.messager.send("Urgent warning: you are over 90% of your quote!");
        } else if percentage_of_max >= 0.75 {
            self.messager.send("Waning: You've used up over 75% of your quota!");
        }
    }
}
...
impl Messager for MockMessager {
    fn send(&self, msg: &str) {  // error ----- help: consider changing this to be a mutable reference: `&mut self`
