if __name__ == "__main__":
    ...
    result = dict(dict5, **dict3)  # use dict5 and dict3 merge and get a new dict
    ...
    dict2.pop('b', [2])  # If key is in the dictionary, remove it and return its value, else return default. If
...
def counter_list(a):
    ...
    print(dect5.pop('c'))
    print(dect3.popitem())
    del dect4  # clear and delete dect4 ,dect4 now don't exist
