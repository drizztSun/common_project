...
def test_dict_basic():
    ...
    # if key not in dict, it will return default-value
    print("Jason : ", tel.get('Jason', 200))

    # getdefault
    print('Jack : ', tel.get('Jack'))
    # if key not in dict, it will return default-value
    print('Lucy : ', tel.get('Lucy', 'default-value'))
    ...
    # setdefault
    # if key in dict, do nothing and return value
    v = tel.setdefault("Tom", 100)
    tel.setdefault("Mary", 200)
    # if key not in dict, it will add key, and then return default-value
    print(tel.setdefault('Dav', 1000))
    ...
    # pop
    # if key in dict, remove key-value and return value
    print("Tom ", tel.pop('Tom', 200))
    # if key not in dict, return default-value.
...
# user-defined dict
# *** Better idea, inherit from Mapping not dict
class mydict(dict):

    def __init__(self, **kwargs):
        super().__init__(**kwargs)

    # like mydict[key], 'get' doesn't go through this
    ...
    # like mydict[key] = value, 'setdefault' doesn't go through this
